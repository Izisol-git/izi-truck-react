...
class OrdersService {
    ...
    static async getSelect(params) {
        const res = await api.get(`/orders/create${params}`);
        return res.data;
    }
    ...
    static async appoint(id , data) {
        const res = await api.post(`/orders/appoint_driver/${id}` , data);
        return res.data;
    }
