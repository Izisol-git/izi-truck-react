                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                        ...
                        <div className="space-y-2">
                            <div>
                                ...
                                <span
                                    className="text-brandBlue-600 font-medium dark:text-darkText">{data?.from_address[0]?.country?.title}</span>
                            </div>
                            <div>
                                <span
                                    className="text-gray-600 dark:text-darkTextTwo">{t("queriesTranslation.logisticsInterface.origin.region")}: </span>
                                <span
                                    className="text-brandBlue-600 font-medium dark:text-darkText">{data?.from_address[0]?.region?.title}</span>
                            </div>
                            <div>
                                <span
                                    className="text-gray-600 dark:text-darkTextTwo">{t("queriesTranslation.logisticsInterface.origin.city")}: </span>
                                <span
                                    className="text-brandBlue-600 font-medium dark:text-darkText">{data?.from_address[0]?.city?.title}</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            <div>
                                ...
                                <span
                                    className="text-brandBlue-600 font-medium dark:text-darkText">{data?.to_address[0]?.country?.title}</span>
                            </div>
                            <div>
                                <span
                                    className="text-gray-600 dark:text-darkTextTwo">{t("queriesTranslation.logisticsInterface.destination.region")}: </span>
                                <span
                                    className="text-brandBlue-600 font-medium dark:text-darkText">{data?.to_address[0]?.region?.title}</span>
                            </div>
                            <div>
                                <span
                                    className="text-gray-600 dark:text-darkTextTwo">{t("queriesTranslation.logisticsInterface.destination.city")}: </span>
                                <span
                                    className="text-brandBlue-600 font-medium dark:text-darkText">{data?.to_address[0]?.city?.title}</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            <div>
                                ...
                                <span
                                    className="text-brandBlue-600 font-medium dark:text-darkText">{data?.client?.fio}</span>
                            </div>
                            <div>
                                <span
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                        ...
                        <div className="space-y-2">
                            <div>
                                ...
                                <span
                                    className="font-medium text-brandBlue-600 dark:text-darkText">{new Date(data?.load_time_from).ddmmyyyy()}</span>
                            </div>
                            <div className="space-y-1">
                                <div>
                                    ...
                                    <span
                                        className="font-medium text-brandBlue-600 dark:text-darkText">{new Date(data?.created_at).ddmmyyyy()}</span>
                                </div>
                                <div>
                                    <span
                                        className="text-gray-600 dark:text-darkTextTwo">{t("queriesTranslation.logisticsInterface.additional.updated")}: </span>
                                    <span
                                        className="font-medium text-brandBlue-600 dark:text-darkText">{new Date(data?.updated_at).ddmmyyyy()}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div>
                                ...
                                <span
                                    className="font-medium text-brandBlue-600 dark:text-darkText">{data?.client_enumeration_price}</span>
                            </div>
                        </div>
                    </div>
