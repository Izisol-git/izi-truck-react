...
const Timeline = () => {
    ...
    const logs = [
        {
            created_at: "2025-07-30T16:46:00Z",
            action: "created",
            user: { name: "Super Admin Kholikulov" },
            data: null,
        },
        {
            ...
            user: { name: "John Doe" },
            data: {
                old: { name: "Ali", status: "inactive" },
                new: { name: "Ali Valiyev", status: "active" },
            },
        },
    ];
                        ...
                        {logs.map((log, index) => {
                            ...
                            return (
                                <div key={index} className="relative pl-12">
                                    <div className="absolute left-[6px] top-2 w-4 h-4 rounded-full bg-gradient-to-br from-indigo-400 to-indigo-600 border-2 border-white dark:border-gray-900 shadow-md"></div>
